...
public class ResultGenerator {
    ...
    private static final String DEFAULT_LOGOUT_SUCCESS_MESSAGE = "登出成功";
    ...
    public static <T> Result<T> genLogoutResult(T data) {
    	 return new Result<T>()
                 .setCode(ResultCodeEnum.SUCCESS)
                 .setMessage(DEFAULT_LOGOUT_SUCCESS_MESSAGE)
                 .setData(data);
    }
